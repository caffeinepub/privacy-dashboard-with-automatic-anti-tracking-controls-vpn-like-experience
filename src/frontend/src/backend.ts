...
export class Backend implements backendInterface {
    ...
    async addBlockEntry(arg0: string): Promise<BlocklistUpdateResult> {
        if (this.processError) {
            try {
                const result = await this.actor.addBlockEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeBlockEntry(arg0: string): Promise<BlocklistUpdateResult> {
        if (this.processError) {
            try {
                const result = await this.actor.removeBlockEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setAutoStopTracking(arg0: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setAutoStopTracking(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
